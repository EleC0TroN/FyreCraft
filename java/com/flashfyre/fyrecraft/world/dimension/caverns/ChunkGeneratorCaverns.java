...
public class ChunkGeneratorCaverns implements IChunkGenerator
{
    ...
    protected static final IBlockState YOUR_LIQUID = Blocks.FLOWING_LAVA.getDefaultState();
    //Blocks that are usually gravel and soul sand
    protected static final IBlockState OTHER_BLOCK1 = Blocks.MONSTER_EGG.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.MONSTER_EGG.getDefaultState();
    ...
    */
    ...
    private final WorldGenerator quartzGen = new WorldGenMinable(BlockInit.PHOSPHITE_ORE.getDefaultState(), 14, BlockMatcher.forBlock(Blocks.STONE));
    private final WorldGenerator magmaGen = new WorldGenMinable(Blocks.GOLD_ORE.getDefaultState(), 33, BlockMatcher.forBlock(Blocks.STONE));
    ...
    public ChunkGeneratorCaverns(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.MINING_CAVERNS);
        }
