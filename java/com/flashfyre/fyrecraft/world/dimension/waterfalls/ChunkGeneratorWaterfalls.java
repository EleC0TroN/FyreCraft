...
public class ChunkGeneratorWaterfalls implements IChunkGenerator
{
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = Blocks.PRISMARINE.getDefaultState();
    //Block that is usually Lava
    protected static final IBlockState YOUR_LIQUID = Blocks.FLOWING_WATER.getDefaultState();
    //Blocks that are usually gravel and soul sand
    protected static final IBlockState OTHER_BLOCK1 = Blocks.FLOWING_WATER.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.FLOWING_WATER.getDefaultState();
    ...
    */
    ...
    private final WorldGenerator quartzGen = new WorldGenMinable(Blocks.FLOWING_WATER.getDefaultState(), 14, BlockMatcher.forBlock(Blocks.PRISMARINE));
    private final WorldGenerator magmaGen = new WorldGenMinable(BlockInit.AQUAMARINE_ORE.getDefaultState(), 33, BlockMatcher.forBlock(Blocks.PRISMARINE));
    
    //private final MapGenStructure HOUSE = new MapGenStructure("house");
    ...
    public ChunkGeneratorWaterfalls(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.WATERFALLS);
        }
